  ...
  def generate(:model) do
    ...
    quote do
      ...
      def delete!(record_id) do
        ...
        case :erlcloud_ddb2.delete_item(table_name, {to_string(key), record_id}, expect_exists(key,record_id)) do
      ...
      def find(record_id) do
        case :erlcloud_ddb2.get_item(table_name, {to_string(key), record_id}) do
          {:ok, []}     -> :not_found
